  ...
  <main>
    <!-- <TheWelcome /> -->
      ...
      <div class="lb-homepage__section lb-homepage__section--gray">
        <div class="lb-homepage__title">解决方案</div>
        <Solution />
      </div>
    ...
    <!-- <div class="lb-homepage__product_item"> -->
      ...
      <div class="lb-homepage__product">
          ...
          <a href="/product_center/148">
            <h3>微纳光学</h3>
            <img width="200px" src="https://images.lbtek.com/test/mall/category/微纳光学-FieYtPgHtT4iElq-8oB51lyERjBF.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/28">
            <h3>光学元件</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光学元件-FnMsBAxRWo_G9Ii4ygCbVQ-uri8T.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/146">
            <h3>光学系统</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光学系统-FgMCOzYiOQo2os6FFTOhriYOIiFy.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/129">
            <h3>光纤及光纤组件</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光纤与光纤组件-Fvde-4A1YeIFcFvu_VTmgCtbaccT.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/185">
            <h3>光学平台与面包板</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光学平台及面包板-FgHFVavYwbEnILCxk9J7Uo0Ay7zy.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/36">
            <h3>光机械件</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光机械件-Fv_M9IKI0fWWclUnz94gUigRCO-7.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/183">
            <h3>运动控制</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/运动控制-Fs-lbWRxrWVxZ0_1IQBAVt7wnseH.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/147">
            <h3>实验室工具</h3>
            <img width="200px" src="https://images.lbtek.com/test/mall/category/实验室工具-Fiw-pXii8uFJO4Oz725Hpej9X21S.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/184">
            <h3>光电探测与分析</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光学系统与仪器-Flj9PnIU8rYRs6Hk3ZNc005pIWQm.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/144">
            <h3>光源</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光源-Fn34GkfhCttBduewsZbwzy1ub02e.png">
          </a>
        </div>
                        <div class="lb-homepage__product_item">
          <a href="/product_center/326">
            <h3>光谱</h3>
            <img width="200px" src="https://images.lbtek.com/mall/category/光谱-FnveLgsldw7Oe7QF4bLAeCBnO-Od.png">
          </a>
        </div>
                                <div class="lb-homepage__product_item">
          <a href="/product_center" style="justify-content: start;">
            <h3 style="margin-top: 20px;">查看更多产品</h3>
            <i style="font-size: 100px;margin-top: 30px;" class="lb-icon-more-product"></i>
          </a>
        </div>
      </div>
    </div>
